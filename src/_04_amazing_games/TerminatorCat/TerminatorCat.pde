...
rottweiler = loadImage("rottweiler.jpg");
...
//                  The ellipse command looks like this:
                ellipse(x, y, 50,50);
                fill(#FF0000);
                ellipse(x+203,y+33, 50,50);
// Run the program to make                                       yre it is in the right place and is the right size.
